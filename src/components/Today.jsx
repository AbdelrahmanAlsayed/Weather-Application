...
function Today() {
     ...
     */
    function mps_to_kmh(mps) { return mps * 3.6; }


    return (
        <section className={styles.hourlyForecast} aria-label="hourly forecast" data-hourly-forecast>
            <h2>Today at</h2>
                    ...
                    {todayAtArr.map((item, index) => (
                        <li className={styles.sliderItem} key={index}>
                            ...
                            <img
                                ...
                                title="direction"
                                loading="lazy"
                                style={{ transform: `rotate(${(item.forecastItem?.wind.deg) - 180}deg)` }}
                            />
